...
#firmware
PRODUCT_COPY_FILES += \
	device/samsung/totoro/prebuilt/firmware/yamato_pfp.fw:system/etc/firmware/yamato_pfp.fw \
	device/samsung/totoro/prebuilt/firmware/yamato_pfp.fw:system/etc/firmware/yamato_pm4.fw \


PRODUCT_COPY_FILES += \
	device/samsung/totoro/prebuilt/egl/libGLES_hgl.so:system/lib/egl/libGLES_hgl.so \
        device/samsung/totoro/prebuilt/libasound.so:system/lib/libasound.so
